...
type CurrentViewType = 'camera' | 'screen' | 'file' | 'image' | 'audience-connection' | 'setting' | 'add-bgm' | 'reverb-voice' | 'change-voice' | 'phone-mirror' | 'online-video' | 'video-file' | 'anchor-connection' | '';
...
export const useCurrentSourceStore = defineStore('currentSource', {
  ...
  actions:{
    ...
    setAnchorConnection(data: {
      ...
      logger.log(`${logPrefix}setAnchorConnection`, this.liveList, this.anchorConnection);
    },
    ...
    setAnchorBattle(data: TUIBattleInfoEx) {
