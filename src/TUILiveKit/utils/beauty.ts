...
// Open-source: green-screen background images are dropped (copyrighted assets).
// Only the single `Blackboard` virtual background is exposed publicly (see
// virtualBackgroundImageList below). water-drops.jpg is also excluded from the
// publish copy (scripts/publish.js) so it is never shipped.
