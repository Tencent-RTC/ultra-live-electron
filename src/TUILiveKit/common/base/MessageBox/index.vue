    ...
    >
      <div class="tui-message-box">
        ...
        <div class="tui-message-box-footer">
          <tui-button v-if="cancelButtonText" class="tui-message-cancel-button" @click="handleCancel">{{ cancelButtonText }}</tui-button>
          <tui-button class="tui-message-confirm-button" type="primary" @click="handleConfirm">{{ confirmButtonText }}</tui-button>
        </div>
      </div>
    </div>
  </transition>
